        ...
        <div class="container-fluid mt-4">
            <div id="animals-container"
                ...
                @foreach ($animals as $animal)
                    ...
                    <div class="col mb-4">
                        <div class="card">
                            <div id="carouselExampleInterval{{ $animal->id }}" class="carousel slide"
                                data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-bs-interval="10000">
                                        <img src="{{ asset('storage/' . $animal->img1) }}" class="d-block w-100 carousel-img" alt="Image 1">
                                    </div>
                                    @if($animal->img2)
                                        <div class="carousel-item" data-bs-interval="10000">
                                            <img src="{{ asset('storage/' . $animal->img2) }}" class="d-block w-100 carousel-img" alt="Image 2">
                                        </div>
                                    @endif
                                    @if($animal->img3)
                                        <div class="carousel-item" data-bs-interval="10000">
                                            <img src="{{ asset('storage/' . $animal->img3) }}" class="d-block w-100 carousel-img" alt="Image 3">
                                        </div>
                                    @endif
                                    @if($animal->img4)
                                        <div class="carousel-item" data-bs-interval="10000">
                                            <img src="{{ asset('storage/' . $animal->img4) }}" class="d-block w-100 carousel-img" alt="Image 4">
                                        </div>
                                    @endif
                                    @if($animal->img5)
                                        <div class="carousel-item" data-bs-interval="10000">
                                            <img src="{{ asset('storage/' . $animal->img5) }}" class="d-block w-100 carousel-img" alt="Image 5">
                                        </div>
                                    @endif
                                </div>
                                </div>
