                    ...
                    <div class="card">
                        <div id="carouselExampleInterval{{ $habitat->id }}" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                @if ($habitat->img2)
                                    <div class="carousel-item">
                                        <img src="{{ asset('storage/' . $habitat->img2) }}" class="d-block w-100"
                                            alt="Image 2" style="max-height: 250px; max-width: 100%; object-fit: contain;">
                                    </div>
                                @endif
                                @if ($habitat->img3)
                                    <div class="carousel-item">
                                        <img src="{{ asset('storage/' . $habitat->img3) }}" class="d-block w-100"
                            ...
                            <button class="carousel-control-prev" type="button"
                                data-bs-target="#carouselExampleInterval{{ $habitat->id }}" data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button"
                                data-bs-target="#carouselExampleInterval{{ $habitat->id }}" data-bs-slide="next">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary d-grid gap-2 col-6 mx-auto"
                                href="/detailHabitat/{{ $habitat->id }}">Voir détail</a>
                        </div>
                    </div>
                </div>
            @endforeach
